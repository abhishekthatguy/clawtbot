    ...
    return (
        <div ref={dropdownRef} className="relative" id="profile-dropdown">
            ...
            <button
                ...
                style={{
                    background: open ? "var(--clawt-surface-2)" : "transparent",
            ...
            >
                {user.avatar_url ? (
                    <img
                        ...
                        style={{ border: "2px solid var(--clawt-border)" }}
                    />
                ) : (
                    <div
                ...
                <div className="hidden md:block text-left">
                    ...
                    <p className="text-[10px] leading-tight" style={{ color: "var(--clawt-text-dim)" }}>
                ...
                <svg
                    ...
                    strokeWidth={2}
                    viewBox="0 0 24 24"
                    style={{ color: "var(--clawt-text-dim)" }}
                >
            ...
            {open && (
                <div
                    ...
                    style={{
                        ...
                        boxShadow: "0 20px 60px rgba(0, 0, 0, 0.5), 0 0 30px rgba(220, 38, 38, 0.08)",
                        animation: "profileDropIn 0.2s ease-out",
                    }}
                >
                    {/* User Header */}
                    <div className="p-4 pb-3" style={{ borderBottom: "1px solid var(--clawt-border)" }}>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                                ...
                                <p className="text-xs truncate" style={{ color: "var(--clawt-text-dim)" }}>
                                    {user.email}
                                </p>
                    ...
                    {/* Activity & Info */}
                    <div className="p-3 space-y-1" style={{ borderBottom: "1px solid var(--clawt-border)" }}>
                        ...
                        <div className="flex items-center justify-between px-2 py-1.5">
                            ...
                            <span className="text-xs font-medium" style={{ color: user.is_2fa_enabled ? "#22c55e" : "var(--clawt-text-dim)" }}>
                    ...
                    {/* Quick Links */}
                    <div className="p-2" style={{ borderBottom: "1px solid var(--clawt-border)" }}>
                        <Link
                            href="/settings"
                            ...
                            onMouseLeave={(e) => {
                                ...
                                e.currentTarget.style.color = "var(--clawt-text-dim)";
                            }}
                        >
