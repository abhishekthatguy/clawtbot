        ...
        >
            <div
                style={{
                    ...
                    boxShadow: "0 25px 60px rgba(0, 0, 0, 0.5), 0 0 40px rgba(220, 38, 38, 0.1)",
                    padding: "2.5rem",
                    textAlign: "center",
            ...
            >
                ...
                >
                    ...
                    Please sign in again to continue using ClawtBot.
                </p>
...
export function SessionProvider({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const handleStorage = (e: StorageEvent) => {
            if (e.key === "clawtbot_token" && !e.newValue) {
                setUser(null);
                if (!isAuthRoute(window.location.pathname)) {
                    setSessionExpired(true);
                }
        ...
        window.addEventListener("clawtbot-session-expired", handleApiExpiry);
        return () => {
            window.removeEventListener("storage", handleStorage);
            window.removeEventListener("clawtbot-session-expired", handleApiExpiry);
        };
    }, []);
