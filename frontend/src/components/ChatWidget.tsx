                ...
                >
                    ...
                    {isDraggingOver && (
                        ...
                        >
                            ...
                            <p className="text-xs mt-1" style={{ color: "var(--clawt-text-dim)" }}>
                    ...
                    <div
                        ...
                        style={{
                            ...
                            borderBottom: "1px solid var(--clawt-border)",
                            cursor: "move",
                        }}
                    >
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <span className="text-[10px]" style={{ color: "var(--clawt-text-dim)" }}>
                                        Online
                                    </span>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <button
                                ...
                                className="w-7 h-7 rounded-lg flex items-center justify-center text-xs transition-all"
                                style={{ background: "transparent", border: "none", cursor: "pointer", color: "var(--clawt-text-dim)" }}
                                title="New chat"
                            >
                                ✨
                            </button>
                            <button
                                ...
                                onMouseLeave={(e) => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.color = "var(--clawt-text-dim)"; }}
                                title="Close"
                            >
                                ✕
                            </button>
                    ...
                    {showHistory && (
                        ...
                        >
                            <p className="text-[10px] font-semibold uppercase mb-1.5" style={{ color: "var(--clawt-text-dim)" }}>
                                Recent Chats
                            </p>
                            {conversations.length === 0 ? (
                                <p className="text-xs py-2" style={{ color: "var(--clawt-text-dim)" }}>No conversations yet</p>
                            ) : (
                                    ...
                                    {conversations.slice(0, 8).map((c) => (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color: c.conversation_id === conversationId ? "white" : "var(--clawt-text-dim)",
                                                border: "none",
                                                cursor: "pointer",
                                            }}
                    ...
                    <div className="flex-1 overflow-y-auto px-3 py-3 space-y-3" id="chat-widget-messages">
                        {messages.length === 0 ? (
                            <div className="flex flex-col items-center justify-center h-full text-center px-4">
                                ...
                                <p className="text-xs mb-5" style={{ color: "var(--clawt-text-dim)" }}>
                                    ...
                                    <div key={i} className={`flex ${msg.role === "user" ? "justify-end" : "justify-start"}`}>
                                        ...
                                        >
                                            ...
                                            <p
                                                ...
                                                style={{ color: msg.role === "user" ? "white" : "var(--clawt-text)" }}
                                            >
                                                {msg.content}
                                            </p>
                                        </div>
                                ...
                                {loading && (
                                    <div className="flex justify-start">
                                        <div
                                            ...
                                            style={{ background: "var(--clawt-surface-2)", border: "1px solid var(--clawt-border)" }}
                                        >
                            ...
                            {attachedImages.length < 5 && (
                                <button
                                    ...
                                    style={{
                                        ...
                                        height: 52,
                                        background: "var(--clawt-surface-2)",
                                        border: "1px dashed var(--clawt-border)",
                                        color: "var(--clawt-text-dim)",
                                        cursor: "pointer",
                                        fontSize: 16,
                                    }}
                    ...
                    <div
                        ...
                        style={{
                            borderTop: "1px solid var(--clawt-border)",
                            background: "rgba(0,0,0,0.2)",
                        }}
                    >
                        {/* Hidden file input */}
                        ...
                        <div className="relative" ref={modeMenuRef}>
                            <button
                                ...
                                style={{
                                    background: showModeMenu ? "rgba(6, 182, 212, 0.15)" : "var(--clawt-surface-2)",
                                    border: "1px solid var(--clawt-border)",
                                    cursor: "pointer",
                                    color: "var(--clawt-text-dim)",
                            ...
                            {showModeMenu && (
                                ...
                                >
                                    <div className="px-3 py-2" style={{ borderBottom: "1px solid var(--clawt-border)" }}>
                                        <p className="text-[10px] font-semibold uppercase tracking-wider" style={{ color: "var(--clawt-text-dim)" }}>
                                            Choose mode
                                        </p>
                                    </div>
                                    <div className="py-1">
                                        {CHAT_MODES.map((mode) => (
                                            <button
                                                ...
                                                style={{
                                                    ...
                                                    border: "none",
                                                    cursor: "pointer",
                                                    color: activeMode === mode.id ? mode.color : "var(--clawt-text)",
                                                }}
                                                onMouseEnter={(e) => {
                                            ...
                                            >
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] leading-tight mt-0.5" style={{ color: "var(--clawt-text-dim)" }}>
                                                        {mode.description}
                                                    </p>
                                                </div>
                                                {activeMode === mode.id && (
