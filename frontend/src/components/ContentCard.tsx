    ...
    return (
        <>
            <div className="glass-card p-5 animate-fade-in" style={{ position: "relative" }}>
                ...
                {/* Topic */}
                <h3 className="text-sm font-bold mb-2 line-clamp-1" style={{ color: "var(--clawt-text)" }}>
                    {topic}
                </h3>

                {/* Hook */}
                {hook && (
                    <p className="text-sm mb-2 line-clamp-2 italic" style={{ color: "var(--clawt-red-glow)" }}>
                        &ldquo;{hook}&rdquo;
                    </p>
                )}

                {/* Caption Preview */}
                <p className="text-xs mb-4 line-clamp-3" style={{ color: "var(--clawt-text-dim)" }}>
                    {caption}
                </p>

                {/* Footer */}
                <div className="flex items-center justify-between pt-3" style={{ borderTop: "1px solid var(--clawt-border)" }}>
                    <div className="flex items-center gap-3">
                        {score !== null && (
                            <div className="flex items-center gap-1">
                                <span className="text-xs" style={{ color: "var(--clawt-text-dim)" }}>Score:</span>
                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-xs font-medium mb-1 block" style={{ color: "var(--clawt-text-dim)" }}>
                                    Hook
                                </label>
                                <input
                                    type="text"
