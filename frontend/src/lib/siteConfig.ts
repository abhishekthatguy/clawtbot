/**
 * ClawtBot — Global Site Configuration
 * ─────────────────────────────────────
...
export const siteConfig = {
    ...
    // ── Creator / Company ─────────────────────────────────────────
    company: {
        name: "ClawtBot Technologies",
        legalName: "ClawtBot Technologies Pvt. Ltd.",
        ...
        about:
            "ClawtBot was born from a vision to democratize AI-powered social media management. Built by Abhishek Singh (Avii), an AI enthusiast and automation architect, ClawtBot brings enterprise-level AI orchestration to everyone — from solo creators to growing businesses. Our multi-agent system handles everything from content creation and hashtag research to smart publishing and audience engagement, all powered by your choice of AI models.",
    },

    // ── Contact ───────────────────────────────────────────────────
    contact: {
        email: "hello@clawtbot.com",
        supportEmail: "support@clawtbot.com",
    ...
    // ── Social Media ──────────────────────────────────────────────
    social: {
        twitter: "https://twitter.com/clawtbot",
        github: "https://github.com/clawtbot",
        linkedin: "https://linkedin.com/company/clawtbot",
        instagram: "https://instagram.com/clawtbot",
        youtube: "https://youtube.com/@clawtbot",
        discord: "https://discord.gg/clawtbot",
    },
    ...
    footerLinks: {
        ...
        company: [
            ...
            { label: "Contact", href: "mailto:hello@clawtbot.com" },
        ],
        legal: [
    ...
    pricing: [
        {
            ...
            price: "Free",
            period: "forever",
            description: "Perfect for exploring ClawtBot's capabilities",
            highlight: false,
            features: [
        ...
        },
        {
            ...
            cta: "Contact Sales",
            ctaLink: "mailto:hello@clawtbot.com?subject=Enterprise%20Plan",
        },
    ],
    ...
    testimonials: [
        {
            ...
            avatar: "PS",
            quote:
                "ClawtBot transformed my workflow. What used to take me 4 hours now happens automatically while I sleep!",
        },
        {
            name: "Alex Chen",
        ...
        },
        {
            ...
            avatar: "MR",
            quote:
                "Managing 12 client accounts used to need a team of 5. Now ClawtBot handles it all with better consistency.",
        },
    ],
