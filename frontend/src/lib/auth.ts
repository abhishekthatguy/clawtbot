...
export function getToken(): string | null {
    ...
    return localStorage.getItem("clawtbot_token");
}

export function setToken(token: string): void {
    localStorage.setItem("clawtbot_token", token);
}

export function setRefreshToken(token: string): void {
    localStorage.setItem("clawtbot_refresh_token", token);
}

export function clearTokens(): void {
    localStorage.removeItem("clawtbot_token");
    localStorage.removeItem("clawtbot_refresh_token");
}

export function setUser(user: AuthUser): void {
    localStorage.setItem("clawtbot_user", JSON.stringify(user));
}

export function getUser(): AuthUser | null {
    if (typeof window === "undefined") return null;
    const raw = localStorage.getItem("clawtbot_user");
...
export function logout(): void {
    clearTokens();
    localStorage.removeItem("clawtbot_user");
