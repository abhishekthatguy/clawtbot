                        ...
                        <div className="grid gap-2">
                            {conversations.map((c) => (
                                ...
                                >
                                    ...
                                    {c.last_at && (
                                        <span className="text-xs ml-2" style={{ color: "var(--clawt-text-dim)" }}>
            ...
            >
                {messages.length === 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center">
                        ...
                        <p className="text-sm mb-8" style={{ color: "var(--clawt-text-dim)", maxWidth: 450 }}>
                            I control the entire ClawtBot system. Ask me anything — create content, configure AI models,
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        border: activeMode === mode.id
                                            ...
                                            : "1px solid var(--clawt-border)",
                                        color: activeMode === mode.id ? mode.color : "var(--clawt-text-dim)",
                                        cursor: "pointer",
                                    }}
                                >
                                    <div
            ...
            >
                ...
                <div className="relative" ref={modeMenuRef}>
                    ...
                    {showModeMenu && (
                        ...
                        >
                            <div className="px-4 py-3" style={{ borderBottom: "1px solid var(--clawt-border)" }}>
                                <p className="text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--clawt-text-dim)" }}>
                                    Choose a mode
                                </p>
                            </div>
                            <div className="py-1">
                                {CHAT_MODES.map((mode) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <p className="text-xs leading-tight mt-0.5 truncate" style={{ color: "var(--clawt-text-dim)" }}>
                                                {mode.description}
                                            </p>
                                        </div>
                                        {activeMode === mode.id && (
