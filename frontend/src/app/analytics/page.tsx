                        ...
                        <button
                            ...
                            style={{
                                background: days === range.days
                                    ...
                                    : "var(--clawt-surface-2)",
                                border: `1px solid ${days === range.days ? "transparent" : "var(--clawt-border)"}`,
                                color: days === range.days ? "white" : "var(--clawt-text-dim)",
                            }}
                        >
                            {range.label}
                        </button>
                        ...
                        <button
                            ...
                            style={{
                                background: selectedPlatform === p.key
                                    ? "rgba(220, 38, 38, 0.15)"
                                    : "var(--clawt-surface-2)",
                                border: `1px solid ${selectedPlatform === p.key ? "#dc2626" : "var(--clawt-border)"}`,
                                color: selectedPlatform === p.key ? "var(--clawt-red-glow)" : "var(--clawt-text-dim)",
                            }}
                        >
                            {p.icon} {p.label}
                        </button>
            ...
            {loading ? (
                ...
                <>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6 stagger-children">
                        {[
                            { label: "Total Likes", value: metrics.likes, icon: "❤️", color: "#dc2626" },
                            ...
                            <div key={stat.label} className="glass-card p-5">
                                ...
                                <p className="text-xs mt-1" style={{ color: "var(--clawt-text-dim)" }}>{stat.label}</p>
                            </div>
                        ))}
                    </div>
