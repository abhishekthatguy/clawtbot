        ...
        return (
            <div className="w-full max-w-md px-4">
                <div className="text-center mb-8 animate-fade-in">
                    ...
                    <p className="text-sm mt-1" style={{ color: "var(--clawt-text-dim)" }}>
                ...
                <div className="glass-card p-8 animate-fade-in">
                    ...
                    <form onSubmit={handle2FAVerify} className="space-y-4">
                        <div>
                            <label className="text-xs font-medium mb-1.5 block" style={{ color: "var(--clawt-text-dim)" }}>
                                6-Digit Code
                            </label>
    ...
    return (
        <div className="w-full max-w-md px-4">
            ...
            <div className="text-center mb-8 animate-fade-in">
                ...
                />
                <h1 className="text-2xl font-bold gradient-text">ClawtBot</h1>
                <p className="text-sm mt-1" style={{ color: "var(--clawt-text-dim)" }}>
            ...
            <div className="glass-card p-8 animate-fade-in">
                ...
                {/* Mode Toggle */}
                <div className="flex mb-6 p-1 rounded-xl" style={{ background: "var(--clawt-surface)" }}>
                    <button
                        onClick={() => { setMode("password"); setError(""); }}
                        className="flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-300"
                        style={{
                            background: mode === "password" ? "linear-gradient(135deg, #06b6d4, #155e75)" : "transparent",
                            color: mode === "password" ? "white" : "var(--clawt-text-dim)",
                        }}>
                        Password
                    </button>
                    <button
                        ...
                        style={{
                            ...
                            color: mode === "otp" ? "white" : "var(--clawt-text-dim)",
                        }}>
                        OTP Login
                    </button>
                </div>
                    ...
                    <form onSubmit={handlePasswordLogin} className="space-y-4">
                        ...
                        <div className="text-right">
                            <Link href="/forgot-password" className="text-xs transition-colors duration-300"
                                ...
                                onMouseEnter={(e) => (e.currentTarget.style.color = "var(--clawt-primary-glow)")}
                                onMouseLeave={(e) => (e.currentTarget.style.color = "var(--clawt-text-dim)")}>
                                Forgot password?
                            </Link>
                        </div>
                ...
                <div className="flex items-center my-6">
                    <div className="flex-1 h-px" style={{ background: "var(--clawt-border)" }} />
                    <span className="px-3 text-xs" style={{ color: "var(--clawt-text-dim)" }}>or continue with</span>
                    <div className="flex-1 h-px" style={{ background: "var(--clawt-border)" }} />
                </div>
