...
export default function SignupPage() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Account Created!", `Welcome to ClawtBot, ${data.user.username}!`);
            refreshSession();
        ...
        <div className="w-full max-w-md px-4">
            ...
            <div className="text-center mb-8 animate-fade-in">
                ...
                <p className="text-sm mt-1" style={{ color: "var(--clawt-text-dim)" }}>
                    Join ClawtBot — AI-powered social media
                </p>
            </div>
                    ...
                    {[
                        ...
                        <button key={m.key}
                            ...
                            style={{
                                ...
                                color: mode === m.key ? "white" : "var(--clawt-text-dim)",
                            }}>
                            {m.label}
                        </button>
                    ))}
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <button key={p.name}
                                ...
                                style={{ background: p.bg, border: "1px solid var(--clawt-border)", color: p.color }}>
