            ...
            <div className="glass-card p-8 animate-fade-in">
                ...
                <div className="flex mb-6 p-1 rounded-xl" style={{ background: "var(--clawt-surface)" }}>
                    <button onClick={() => setMethod("link")}
                        ...
                        style={{
                            background: method === "link" ? "linear-gradient(135deg, #dc2626, #b91c1c)" : "transparent",
                            color: method === "link" ? "white" : "var(--clawt-text-dim)",
                        }}>
                        Reset Link
                    </button>
                    <button onClick={() => setMethod("otp")}
                        className="flex-1 py-2 px-3 rounded-lg text-sm font-medium transition-all duration-300"
                        style={{
                            background: method === "otp" ? "linear-gradient(135deg, #dc2626, #b91c1c)" : "transparent",
                            color: method === "otp" ? "white" : "var(--clawt-text-dim)",
                        }}>
                        OTP Code
                    </button>
                </div>
                ...
                <div className="mt-6 text-center">
                    <Link href="/login" className="text-sm transition-colors duration-300"
                        ...
                        onMouseEnter={(e) => (e.currentTarget.style.color = "var(--clawt-red-glow)")}
