                                    ...
                                    <button
                                        ...
                                        style={{
                                            background: platform === p
                                                ...
                                                : "var(--clawt-surface)",
                                            border: `1px solid ${platform === p ? "#dc2626" : "var(--clawt-border)"}`,
                                            color: platform === p ? "white" : "var(--clawt-text-dim)",
                                        }}
                                    >
                                        {p === "instagram" && "📸 "}
                                        {p === "facebook" && "👤 "}
                            ...
                            {[
                                ...
                                <div key={item.step} className="flex items-center gap-3 p-3 rounded-lg"
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs" style={{ color: "var(--clawt-text-dim)" }}>{item.desc}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
