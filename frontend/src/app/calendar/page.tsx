    ...
    return (
        <div className="animate-fade-in">
            ...
            <div
                ...
                style={{ background: "var(--clawt-surface)" }}
            >
                {[
                    ...
                    <button
                        ...
                        style={{
                            background: activeTab === tab.key
                                ...
                                : "transparent",
                            color: activeTab === tab.key ? "white" : "var(--clawt-text-dim)",
...
function StatCard({ icon, label, value, color }: { icon: string; label: string; value: number | string; color: string }) {
    return (
        <div className="glass-card p-5">
            ...
            <p className="text-xs" style={{ color: "var(--clawt-text-dim)" }}>{label}</p>
        </div>
    );
}
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    style={{ background: "var(--clawt-surface-2)", color: "var(--clawt-text-dim)" }}
                >
                    {entry.row_number || "–"}
                </div>
                ...
                <div className="w-32 shrink-0">
                    <span
                        ...
                        style={{ background: "var(--clawt-surface-2)" }}
                    >
                        {entry.brand || "—"}
                    </span>
                </div>
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {entry.content_type && (
                        <p className="text-[10px] mt-0.5" style={{ color: "var(--clawt-text-dim)" }}>
                            {entry.content_type}
                        </p>
                    )}
                </div>
            ...
            {expanded && (
                <div
                    ...
                    style={{ borderColor: "var(--clawt-border)" }}
                >
                    {/* Pipeline progress */}
                    <div className="mb-4">
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    background: entry.status === "failed"
                                        ? "#ef4444"
                                        : "linear-gradient(90deg, #dc2626, #8b5cf6)",
                                }}
                            />
                        </div>
                        {/* Stage dots */}
...
function DetailItem({ label, value }: { label: string; value: string | null | undefined }) {
    return (
        <div>
            <p className="text-[10px] font-medium uppercase mb-1" style={{ color: "var(--clawt-text-dim)" }}>
                {label}
            </p>
    ...
    return (
        <div className="text-center py-12">
            <div className="inline-block w-8 h-8 border-2 border-t-transparent rounded-full animate-spin mb-4"
                style={{ borderColor: "var(--clawt-primary)", borderTopColor: "transparent" }}
            />
            <p className="text-sm" style={{ color: "var(--clawt-text-dim)" }}>{message}</p>
        </div>
    );
}
...
function EmptyState({
    ...
    return (
        <div
            ...
            style={{ background: "var(--clawt-surface)", border: "1px dashed var(--clawt-border)" }}
        >
            <p className="text-5xl mb-4">{icon}</p>
            <p className="text-lg font-semibold mb-2">{title}</p>
            <p className="text-sm mb-6" style={{ color: "var(--clawt-text-dim)" }}>{description}</p>
            {action && (
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Calendar name */}
                <div className="mb-4">
                    <label className="text-xs font-medium mb-2 block" style={{ color: "var(--clawt-text-dim)" }}>
                ...
                <div className="flex gap-2 mb-6">
                    {[
                        ...
                        >
                            ...
                            <p className="text-[10px] mt-1" style={{ color: "var(--clawt-text-dim)" }}>
                                {type.desc}
                            </p>
                        </button>
                    ))}
                ...
                {/* Help text */}
                <div className="mt-6 p-4 rounded-xl" style={{ background: "var(--clawt-surface-2)" }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 stagger-children">
            ...
            <div className="glass-card p-6">
                ...
                {statusEntries.length === 0 ? (
                    <p className="text-sm" style={{ color: "var(--clawt-text-dim)" }}>No data yet</p>
                ) : (
