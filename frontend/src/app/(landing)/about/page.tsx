            ...
            <div className="max-w-5xl mx-auto px-6 py-16">
                ...
                <div className="text-center mb-20">
                    ...
                    <h1
                        ...
                        style={{
                            background: "linear-gradient(135deg, #ffffff 0%, #dc2626 70%)",
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(135deg, rgba(220, 38, 38, 0.08) 0%, rgba(139, 92, 246, 0.05) 100%)",
                ...
                <div className="mb-16">
                    ...
                    >
                        ...
                        <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.6)" }}>
                            ...
                            full-stack development, Avii built ClawtBot to solve the real challenges of social media management at scale.
                        </p>
