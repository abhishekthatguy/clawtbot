    ...
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="glass-card p-6 lg:col-span-2">
          ...
          {platformKeys.length === 0 ? (
            ...
            >
              ...
              <p className="text-xs mb-4" style={{ color: "var(--clawt-text-dim)" }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                      {accounts.map((acc) => (
                        <div key={acc.id} className="flex items-center gap-2">
                          ...
                          <span className="text-xs truncate" style={{ color: "var(--clawt-text-dim)" }}>
              ...
              >
                ...
                <span className="text-xs" style={{ color: "var(--clawt-text-dim)" }}>
                  Add Platform
                </span>
              </Link>
            </div>
        ...
        <div className="glass-card p-6">
          ...
          {/* Pipeline mini-flow */}
          <div className="mt-6">
            <h3 className="text-xs font-semibold mb-3" style={{ color: "var(--clawt-text-dim)" }}>
              PIPELINE FLOW
            </h3>
            <div className="flex items-center gap-1.5 flex-wrap text-[10px]">
              {["Create", "→", "Hashtag", "→", "Review", "→", "Approve", "→", "Publish", "→", "Engage"].map(
                (step, i) =>
                  step === "→" ? (
                    <span key={i} style={{ color: "var(--clawt-primary)" }}>→</span>
                  ) : (
                    <span
                      key={i}
        ...
        <div className="glass-card p-6 mb-8">
                ...
                <button
                  ...
                  style={{
                    background: isActive
                      ...
                      : "transparent",
                    color: isActive ? meta.color : "var(--clawt-text-dim)",
          ...
          {activePlatform && connectedPlatforms[activePlatform]?.length > 1 && (
            <div className="mb-4 flex items-center gap-2">
              <span className="text-xs font-medium" style={{ color: "var(--clawt-text-dim)" }}>
                Account:
              </span>
              <select
    ...
    >
      <div className="flex items-start justify-between gap-4">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs leading-relaxed" style={{ color: "var(--clawt-text-dim)" }}>
            {preview}
          </p>
          <p className="text-[10px] mt-2" style={{ color: "var(--clawt-text-dim)", opacity: 0.6 }}>
