...
<img src="../docs/assets/logo.png" alt="ClawtBot Logo" width="80">
...
> **Note:** The frontend needs the backend running to function. Start everything with `clawtbot start` from the project root.
...
These are automatically set by `clawtbot start` based on `.env` port configuration.
...
Part of [**ClawtBot**](../README.md) — Built by **Abhishek Singh (Avii)**
