# 🔑 ClawtBot — How to Get All Your API Keys
...
```env
DATABASE_URL=postgresql+asyncpg://clawtbot_user:pick_a_password@postgres:5432/clawtbot_db
POSTGRES_USER=clawtbot_user
POSTGRES_PASSWORD=pick_a_password
POSTGRES_DB=clawtbot_db
...
This is a secret password that ClawtBot uses internally to keep user login sessions safe. Nobody else needs to see it.
...
4. Give your app a name (e.g., "ClawtBot") → **Create App**
...
2. Name your project (e.g., "ClawtBot")
3. Name your app (e.g., "ClawtBot App")
...
2. If asked, configure the **OAuth consent screen** first:
   ...
   - Fill in app name ("ClawtBot"), your email → Save
