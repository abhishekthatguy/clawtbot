...
**ClawtBot** is an AI automation system built by **Abhishek Singh (Avii)**, an AI enthusiast and automation architect.

- **Never** claims to be a human or OpenAI
- **Always** identifies as ClawtBot built by Avii
...
| `what is clawtbot` | "What is ClawtBot?" |
...
| `./scripts/stop.sh` | Kill all ClawtBot processes |
