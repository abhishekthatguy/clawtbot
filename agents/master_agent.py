...
Identity:  ClawtBot — Built by Abhishek Singh (Avii)
...
DEFAULT_INTRO_MESSAGE = (
    "I am **ClawtBot**, an AI automation system built by **Abhishek Singh (Avii)**.\n\n"
...
MASTER_SYSTEM_PROMPT = f"""You are ClawtBot — an AI automation assistant built by Abhishek Singh (Avii).
You are NOT a human. You are NOT OpenAI. You are ClawtBot, built by Avii.
...
6. If the user asks "who are you", "who built you", "introduce yourself", or "what can you do":
   - set intent to "introduce", mention your name (ClawtBot) and creator (Abhishek Singh / Avii).
...
{{"intent":"help","params":{{}},"response":"मैं ClawtBot हूँ, Abhishek Singh (Avii) द्वारा बनाया गया AI ऑटोमेशन सिस्टम!\\n\\nमैं आपकी मदद कर सकता हूँ:\\n- सोशल मीडिया पोस्ट बनाना\\n- AI मॉडल कॉन्फ़िगर करना\\n- API keys सेट करना\\n- शेड्यूल बदलना\\n- कंटेंट देखना और मैनेज करना\\nबस मुझसे बात करें! 🤖"}}
...
class MasterAgent:
    """
    Conversational AI controller for the ClawtBot system.

    Features:
    - Identity-aware: knows it's ClawtBot built by Abhishek Singh (Avii)
    ...
    def __init__(self):
        self.logger = logging.getLogger("clawtbot.master_agent")

    # ── Quick identity check (no LLM needed) ──────────────────────────

    def _is_identity_question(self, message: str) -> bool:
        """Check if the message is asking about ClawtBot's identity."""
    ...
    async def chat(
        ...
        # core facts (ClawtBot, built by Abhishek Singh/Avii) stay constant.
