"""
ClawtBot — Centralized Configuration
...
class Settings(BaseSettings):
    ...
    def _derive_urls_from_ports(self) -> "Settings":
        ...
        if not self.database_url:
            self.database_url = (
                f"postgresql+asyncpg://clawtbot_user:password@localhost:{self.postgres_port}/clawtbot_db"
            )
        if not self.database_url_sync:
            self.database_url_sync = (
                f"postgresql://clawtbot_user:password@localhost:{self.postgres_port}/clawtbot_db"
            )
        return self
